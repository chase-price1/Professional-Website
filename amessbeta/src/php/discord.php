<?php
//#THIS HAS BECOME MY PHP FUNCTION PAGE

//^START OF DISCORD LOGIN FUNCTIONS
...
function get_user()
{
    ...
    $_SESSION['accent_color'] = $results['accent_color'];
    $_SESSION['banner_color'] = $results['banner_color'];
    $_SESSION['user_flags'] = $results['public_flags'];
    $_SESSION['premium_type'] = $results['premium_type'];
...
{
    if(isset($_SESSION['banner_color'])) {
            return $_SESSION['banner_color'];
    } else {
        return '#eea141';
    }
}